 ...
 */
class EshipperHttpConnection
{

  /**
   * @var EshipperHttpConfig
   */
  private $httpConfig;
   ...
   */
  public function __construct(EshipperHttpConfig $httpConfig, array $config)
  {
    if (!function_exists("curl_init")) {
      throw new EshipperConfigurationException("Curl module is not available on this system");
    }
  ...
  public function execute($data)
  {
    ...
    if (curl_errno($ch)) {
      $ex = new EshipperConnectionException(
